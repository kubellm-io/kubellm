...
import (
	...
	apisiamkubellmiov1alpha1 "github.com/kubellm-io/kubellm/pkg/apis/iam.kubellm.io/v1alpha1"
	...
	iamkubellmiov1alpha1 "github.com/kubellm-io/kubellm/pkg/generated/listers/iam.kubellm.io/v1alpha1"
...
type UserInformer interface {
	...
	Lister() iamkubellmiov1alpha1.UserLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.IamV1alpha1().Users().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.IamV1alpha1().Users().Watch(context.TODO(), options)
			},
		},
		&apisiamkubellmiov1alpha1.User{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *userInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisiamkubellmiov1alpha1.User{}, f.defaultInformer)
}

func (f *userInformer) Lister() iamkubellmiov1alpha1.UserLister {
	return iamkubellmiov1alpha1.NewUserLister(f.Informer().GetIndexer())
}
