...
import (
	...
	apisclusterkubellmiov1alpha1 "github.com/kubellm-io/kubellm/pkg/apis/cluster.kubellm.io/v1alpha1"
	...
	clusterkubellmiov1alpha1 "github.com/kubellm-io/kubellm/pkg/generated/listers/cluster.kubellm.io/v1alpha1"
...
type ClusterInformer interface {
	...
	Lister() clusterkubellmiov1alpha1.ClusterLister
}
...
func NewFilteredClusterInformer(client versioned.Interface, resyncPeriod time.Duration, indexers cache.Indexers, tweakListOptions internalinterfaces.TweakListOptionsFunc) cache.SharedIndexInformer {
	return cache.NewSharedIndexInformer(
		...
		&apisclusterkubellmiov1alpha1.Cluster{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisclusterkubellmiov1alpha1.Cluster{}, f.defaultInformer)
}

func (f *clusterInformer) Lister() clusterkubellmiov1alpha1.ClusterLister {
	return clusterkubellmiov1alpha1.NewClusterLister(f.Informer().GetIndexer())
}
